...
public class ClaimComment implements Serializable {
    ...
    public ClaimComment users(Set<User> users) {
        this.users = users;
        return this;
    }

    public ClaimComment addUser(User user) {
        this.users.add(user);
        user.setClaimComment(this);
        return this;
    }

    public ClaimComment removeUser(User user) {
        this.users.remove(user);
        user.setClaimComment(null);
        return this;
    }

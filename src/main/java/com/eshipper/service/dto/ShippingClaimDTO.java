...
public class ShippingClaimDTO implements Serializable {
    ...
    private Long claimAttachmentId;
    ...
    public Long getClaimAttachmentId() {
        return claimAttachmentId;
    }

    public void setClaimAttachmentId(Long claimAttachmentId) {
    ...
    public String toString() {
        return "ShippingClaimDTO{" +
            ...
            ", claimAttachmentId=" + getClaimAttachmentId() +
